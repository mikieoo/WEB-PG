...
/*
    ...
    - !== : 불일치 비교
*/
// 동등, 부등 비교는 자동형변환을 수행후 연산 진행 (데이터 타입의 영향을 받지 않음)
console.log(10 == '10');
// 일치, 불일치 비교는 형변환을 수행하지 않음 (데이터 타입의 영향을 받음)
console.log(10 === '10');

/*
    대소 관계 비교 연산자 : 피연산자의 크기를 비교하여 논리 값으로 변환
    - > : 좌항이 우항보다 크다
    - < : 좌항이 우항보다 작다
    - >= : 좌항이 우항보다 크거나 같다
    - <= : 좌항이 우항보다 작거나 같다
...
*/
var number = 9;
var result = number % 2 === 0 ? '짝수' : '홀수'; // 짝수
var result = number % 2 ? '홀수' : '짝수'; // 홀수 (값이 0이기 때문에 )
console.log(result);
